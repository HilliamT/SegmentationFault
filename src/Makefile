...
LDLIBS    = -lcurl
VPATH     = display/:query/:query/:query/lib-cjson/:../:language_inference/predict_language/:language_inference/search_suggest/:language_inference/predict_language/large_double
